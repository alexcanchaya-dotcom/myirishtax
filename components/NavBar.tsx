...
const navLinks = [
  ...
  { href: 'https://ledger.myirishtax.com', label: 'Books', external: true },
            ...
            {navLinks.map((link) =>
              'external' in link && link.external ? (
                <a
                  ...
                  className="block px-3 py-2 rounded-md text-sm font-medium text-gray-700 transition-colors hover:bg-gray-50 hover:text-gray-900"
                >
                  {link.label}
                </a>
              ) : (
